...
public class TestAnimatedPane {
	...
	public class TestPane extends JPanel {
		...
		public TestPane() {
			...
			Rectangle from = new Rectangle(size.width, (size.height - 50) / 2,
					50, 50);
			Rectangle to = new Rectangle((size.width - 50) / 2,
					(size.height - 50) / 2, 50, 50);
	...
	public static Rectangle calculateProgress(Rectangle startBounds,
	...
	public static Point calculateProgress(Point startPoint, Point targetPoint,
			double progress) {
	...
	public static int calculateProgress(int startValue, int endValue,
			double fraction) {
