...
public class FurkTransferHandler extends TransferHandler {
	...
	public boolean canImport(TransferHandler.TransferSupport support) {
		...
		if(!(target instanceof FolderTreeNode)) return false; 
		TreePath path = tree.getPathForRow(selRows[0]);
		DefaultMutableTreeNode firstNode = (DefaultMutableTreeNode) path
				.getLastPathComponent();
		if(!(firstNode instanceof FileTreeNode)) return false;
